package com.hewuzhao.cachecontrast.blobcache;
...
public class ResourceUtil {
    ...
    public static Bitmap getBitmap(String drawableName, BitmapFactory.Options options) {
        return BitmapFactory.decodeResource(MyApplication.sApplication.getResources(),
                getDrawableId(MyApplication.sApplication, drawableName), options);
    }
